...
freq = [8, 13]                    # Interval of frequencies used to compute the PSD/PLI during the feature extraction
freq_scorepochs = [1, 40]         # Interval of frequencies used to compute the PSD/PLI using ScorEpochs
...
# Creates the initial dataset (has to slightly change if the chosen dataset is different)
